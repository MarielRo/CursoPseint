Algoritmo CuadradoMagico
	...
	Definir matriz,fil,col,matriz2,num,veces,posicion,cont1,cont2, dim,numrepetido,consMagica Como Entero
	...
	Repetir
		...
		//Imprime la segunda matriz con los números que el usuario va ingresando.
		Para fil=0 Hasta 2 Hacer
			Para col=0 Hasta 2 Hacer
	...
	//Se verifica si las filas,columna y diagonal suman 15 para escribir que si es o no, un cuadrado magico.
//	
//	//Para las filas de la matriz.
//	Repetir 
//		//Para las columnas de la matriz.
//		Repetir
//			Si matriz2[fil,col] == consMagica
